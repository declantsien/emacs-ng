...
extern void wr_set_background_color (struct frame *f, Lisp_Object arg, Lisp_Object oldval);
extern void wr_set_cursor_color (struct frame *f, Lisp_Object arg, Lisp_Object oldval);
extern void wr_scroll_run (struct window *w, struct run *run);
extern void pgtk_after_update_window_line (struct window *w,
