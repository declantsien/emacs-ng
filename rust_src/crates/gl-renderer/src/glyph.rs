...
use emacs::display_traits::DrawGlyphsFace;
use emacs::display_traits::FaceUnderlineType;
...
pub trait GlyphStringExtGlRenderer {
    fn set_gc(&mut self);
...
impl GlyphStringExtGlRenderer for GlyphStringRef {
